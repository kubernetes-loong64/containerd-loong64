...
Push a branch named `loong64-<containerd-version>` (e.g. `loong64-v2.4.0`) to trigger a build. Append `+<build>`
(e.g. `loong64-v2.4.0+0`) to include build metadata.

## [Release](https://github.com/kubernetes-loong64/containerd-loong64/releases)

Push a tag matching `release-loong64-<containerd-version>` (e.g. `release-loong64-v2.4.0+0`) to publish
